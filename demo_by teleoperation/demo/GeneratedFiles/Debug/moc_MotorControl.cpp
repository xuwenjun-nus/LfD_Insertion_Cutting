...
const QMetaObjectExtraData MotorControl::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MotorControl::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_MotorControl,
      qt_meta_data_MotorControl, &staticMetaObjectExtraData }
};
